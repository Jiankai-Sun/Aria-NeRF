...
def extract_vrs(scene_name='Lounge_1'):
    mps_sample_path = "${DATASET_DIR}"+scene_name
...
if __name__ == '__main__':
    scene_name_list = ['Conference_Room_2', 'Drone_Workbench_3', 'Kitchen_1', 'Lounge_2', 'Robot_Workstation_1',
                       'Drone_Workbench_1', 'Flightroom', 'Kitchen_2', 'Lounge_3', 'Robot_Workstation_2',
                       'Drone_Workbench_2', 'Fountain1', 'Lounge_1', 'Patio_1'
                      ]
    for scene_name in scene_name_list:
        extract_vrs(scene_name)
