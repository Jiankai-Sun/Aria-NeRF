        ...
        with TimeWriter(writer, EventName.TOTAL_TRAIN_TIME):
            ...
            for step in range(self._start_step, self._start_step + num_iterations):
                ...
                if step_check(step, self.config.logging.steps_per_log, run_at_zero=True):
                    ...
                    #     psnr = metrics_dict['psnr'].cpu().numpy()
                    #     metrics_dict['psnr'] = psnr
                    # if 'distortion' in metrics_dict:
                    #     psnr = metrics_dict['distortion'].cpu().numpy()
                    #     metrics_dict['distortion'] = psnr
                    # if 'camera_opt_translation' in metrics_dict:
                    #     psnr = metrics_dict['camera_opt_translation'].cpu().numpy()
                    #     metrics_dict['camera_opt_translation'] = psnr
                    # if 'camera_opt_rotation' in metrics_dict:
                    #     psnr = metrics_dict['camera_opt_rotation'].cpu().numpy()
                    #     metrics_dict['camera_opt_rotation'] = psnr
                    # if 'camera_opt_rotation' in metrics_dict:
                    #     psnr = metrics_dict['camera_opt_rotation'].cpu().numpy()
                    #     metrics_dict['camera_opt_rotation'] = psnr
                    # if 'camera_opt_rotation' in metrics_dict:
                    ...
                    #     psnr = metrics_dict['ssim'].cpu().numpy()
                    #     metrics_dict['ssim'] = psnr
                    # if 'lpips' in metrics_dict:
                    #     psnr = metrics_dict['lpips'].cpu().numpy()
                    #     metrics_dict['lpips'] = psnr
                    # print('step: {}, metrics_dict: {}'.format(step, metrics_dict_np))
